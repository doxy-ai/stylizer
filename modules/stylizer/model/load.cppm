...
export module stylizer.model:load;
// export module stylizer.model.load;
...
namespace stylizer { inline namespace models {
	...
	export model load_tinyobj_model_with_material(stylizer::context& ctx, std::span<std::byte> memory, std::span<std::byte> mtl) {
	...
	export model load_tinyobj_model(stylizer::context& ctx, std::span<std::byte> memory, std::string_view extension = {}) {
		return load_tinyobj_model_with_material(ctx, memory, {});
	}

	export maybe_owned<model> load_tinyobj_model_generic(stylizer::context& ctx, std::span<std::byte> memory, std::string_view extension = {}) {
